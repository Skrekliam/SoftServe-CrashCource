...
class Calculator {
    ...
    public static void calcul(){
        ...
        while (step < 4){
            ...
            switch (step){
                case 0 : i = smbS.indexOf('*'); if(i<0){ step++;continue;}else{ Arr[i] = Arr[i] * Arr[i + 1]; } break;
                case 1 : i = smbS.indexOf('/'); if(i<0) { step++;continue;}else{ Arr[i] = Arr[i] / Arr[i + 1]; } break;
                case 2 : i = smbS.indexOf('+'); if(i<0) { step++;continue; }else{ Arr[i] = Arr[i] + Arr[i + 1];} break;
                case 3 : i = smbS.indexOf('-');  if(i<0) { step++;continue;}else{ Arr[i] = Arr[i] - Arr[i + 1];}break;
